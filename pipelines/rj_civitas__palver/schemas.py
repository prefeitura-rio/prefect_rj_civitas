...
def get_source_schema(source: Literal["news", "press", "whatsapp", "radio.medias", "television", "twitter"]):
    schemas = {
        "news": [
            ...
            bigquery.SchemaField(name="main_location_city", field_type="STRING", mode="NULLABLE"),
            bigquery.SchemaField(name="main_location_neighborhood", field_type="STRING", mode="NULLABLE"),
            bigquery.SchemaField(name="main_location_street", field_type="STRING", mode="NULLABLE"),
